...
class Usuario(models.Model):
    # NUEVOS CAMPOS para calzar con tu UI:
    ci = models.CharField(max_length=20, default="00000000")          # <- nuevo
    direccion = models.CharField(max_length=255, default="")          # <- nuevo
    activo = models.BooleanField(default=True)                         # <- nuevo

    # LO QUE YA TENÍAS (ajustamos nombre para tu UI):
    nombre_completo = models.CharField(max_length=100)
    clave = models.CharField(max_length=100)                          # si no la usas aún, déjala
    telefono = models.CharField(max_length=20)
    email = models.EmailField(max_length=100)
    tipo = models.CharField(max_length=30, default="Usuario")         # opcional
