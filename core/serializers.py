...
from .models import Usuario, Rol, Vehiculo, AreasComunes, Reservas, Residencias, Cuotas, Pagos, Mantenimientos, EventosSeguridad, Notificacion, Conversacion, Mensaje
...
class UsuarioSerializer(serializers.ModelSerializer):
    # Alias de lectura (tu front usa "nombre")
    nombre = serializers.CharField(source="nombre_completo")
    # Leer: objeto completo del rol
    rol = RolSerializer(read_only=True)
    # Extra: nombre del rol, por si alguna vez "rol" no viene anidado
    rol_nombre = serializers.CharField(source="rol.nombre_rol", read_only=True)
    # Escribir: sólo id del rol
